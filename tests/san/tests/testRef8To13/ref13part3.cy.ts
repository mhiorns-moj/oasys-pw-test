    ...
    it('Test ref 13 - Another 3.2 assessment in pilot area', () => {
        ...
        cy.task('retrieveValue', 'offender').then((offenderData) => {
            ...
            cy.get<number[]>('@pks').then((pks) => {
                ...
                await sections.predictors.arp.checkValue('Unable to calculate', true)
                await sections.predictors.vrp.checkValue('Unable to calculate', true)
                await sections.predictors.svrp.checkValue('Unable to calculate', true)
