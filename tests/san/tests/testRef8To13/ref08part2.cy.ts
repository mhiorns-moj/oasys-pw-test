    ...
    it('Test ref 8 part 2 - Create and check SAN assessment', () => {
        ...
        cy.task('retrieveValue', 'offender').then((offenderData) => {
            ...
            cy.get<number>('@result').then((pk) => {
                ...
                await sections.predictors.o1_46.checkLabel('Number of previous/current sanctions involving indecent child image or indirect child contact sexual/sexually motivated offences')
