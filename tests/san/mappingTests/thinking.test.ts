...
test('Mapping test: thinking part 1', async ({ oasys, offender, assessment, sections, san }) => {

    await mappingTest(oasys, offender, assessment, sections, san, data.Thinking.script)
})