...
describe('Mapping test for drugs - individual drugs details', () => {
    ...
    test('amphetamines', () => { drugTest('amphetamines') })
    test('benzodiazepines', () => { drugTest('benzodiazepines') })
    test('cannabis', () => { drugTest('cannabis') })
    test('cocaine', () => { drugTest('cocaine') })
    test('crack', () => { drugTest('crack') })
    test('ecstasy', () => { drugTest('ecstasy') })
    test('hallucinogenics', () => { drugTest('hallucinogenics') })
    test('heroin', () => { drugTest('heroin') })
    test('methadone', () => { drugTest('methadone') })
    test('prescribed', () => { drugTest('prescribed') })
    test('opiates', () => { drugTest('opiates') })
    test('solvents', () => { drugTest('solvents') })
    test('spice', () => { drugTest('spice') })
    test('steroids', () => { drugTest('steroids') })
    test('other', () => { drugTest('other') })
