...
test('Mapping test: alcohol part 1', async ({ oasys, offender, assessment, sections, san }) => {

    await mappingTest(oasys, offender, assessment, sections, san, data.Alcohol.script)
})