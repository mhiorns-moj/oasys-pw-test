...
test('Mapping test: thinking part 2', async ({ oasys, offender, assessment, sections, san }) => {

    await mappingTest(oasys, offender, assessment, sections, san, data.Thinking2.script)
})