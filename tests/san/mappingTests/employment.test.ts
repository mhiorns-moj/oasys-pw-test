...
test('Mapping test: employment', async ({ oasys, offender, assessment, sections, san }) => {

    await mappingTest(oasys, offender, assessment, sections, san, data.Employment.script)
})