...
test('Example test - create a probation offender and a layer 3 assessment using new SP service', async ({ oasys, offender, assessment }) => {
    ...
    await assessment.populateMinimal({ layer: 'Layer 3', newSp: true })
