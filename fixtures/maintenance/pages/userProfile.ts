...
export class UserProfile extends OasysPage {
    ...
    providerEstablishment = new Element.Select(this.page, '#P7_AREA_ESTABLISHMENT')
    team = new Element.Select(this.page, '#P7_TEAM')
    ...
    existingProfile = new Element.Column(this.page, Element.ColumnType.Column, 'Existing Profile')
    profileStatusColumn = new Element.Column(this.page, Element.ColumnType.Column, 'User Status')
}
