...
export class V1EndpointResponse extends common.EndpointResponse {
    ...
    addLatestAssessment(dbAssessments: dbClasses.DbAssessmentOrRsr[], assessmentType: any, complete: boolean): number {
    ...
    addAllAssessments(dbAssessments: dbClasses.DbAssessmentOrRsr[], assessmentType: any, complete: boolean) {
