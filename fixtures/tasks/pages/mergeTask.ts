...
export class MergeTask extends OasysPage {
    ...
    offender1DateOfBirth = new Element.Textbox<OasysDate>(this.page, '#P1_OFF_1_DATE_OF_BIRTH', true)
    ...
    offender2DateOfBirth = new Element.Textbox<OasysDate>(this.page, '#P1_OFF_2_DATE_OF_BIRTH', true)
