...
export class SigningStatus extends OasysPage {
    ...
    noSaraReason = new Element.Select<'There was no suitably trained assessor available' | 'There are no indications within the current OASys that a SARA is required e.g. domestic abuse has occurred outside of Intimate Partner Abuse'>(this.page, '#P3_SARA_REASON_ELM')
