...
export function fullyPopulated(maxStrings: boolean = false) {
    ...
    page.briefOffenceDetails.setValue(maxStrings ? utils.oasysString(4000) : 'Brief offence details')
    page.o2_2Weapon.setValue('Yes')
    page.o2_2SpecifyWeapon.setValue(maxStrings ? utils.oasysString(96) : 'A big weapon')
    ...
    page.o2_4Relationship.setValue(maxStrings ? utils.oasysString(4000) : 'Victim - perpetrator relationship')
    page.o2_4OtherInformation.setValue(maxStrings ? utils.oasysString(4000) : 'Any other information of specific note, consider vulnerability')
    page.impactOnVictim.setValue(maxStrings ? utils.oasysString(4000) : 'Impact on the victim')
    page.impactRecognised.setValue('Yes')
