...
export class Risk {
    ...
    roshScreeningSection1 = new pages.RoshScreeningSection1(this.page)
    roshScreeningSection2to4 = new pages.RoshScreeningSection2to4(this.page)
    roshScreeningSection5 = new pages.RoshScreeningSection5(this.page)
