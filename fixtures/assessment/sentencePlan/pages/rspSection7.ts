...
export class RspSection7 extends SentencePlan {
    ...
    objectives = new CommonTables.ObjectivesTable(this.page, 'R7307124677951782', 'Objectives')
    ...
    crimNeedTable = new RspCrimNeedTable(this.page, 'R3720403791960688', 'RSP Criminogenic Needs')
    sanCrimNeedTable = new RspCrimNeedTable(this.page, 'R3982355349224802', 'RSP SAN Criminogenic Needs')
    predictorsTable = new CommonTables.PredictorsTable(this.page, 'R3328116188259315', 'RSP Predictor Scores')
    weightedScoresTable = new CommonTables.WeightedScoresTable(this.page, 'R2896618293122266', 'RSP Weighted Scores')
...
export class RspCrimNeedTable extends Element.Table {
    ...
    strengths = new Element.Column(this.page, Element.ColumnType.Column, `#RELATED_STRENGTHS_${this.id}`, this.id)
