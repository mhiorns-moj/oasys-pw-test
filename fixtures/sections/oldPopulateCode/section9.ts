...
export function fullyPopulated(maxStrings: boolean = false) {
    ...
    page.o9_1Details.setValue(maxStrings ? utils.oasysString(4000) : '9.1 Details')
    ...
    page.identifyIssues.setValue(maxStrings ? utils.oasysString(4000) : 'Section 9 issues')
