...
export class SummarySheet extends BaseAssessmentPage {
    ...
    crimTable = new CommonTables.SummarySheetCrimTable(this.page, 'R4170407686105861', 'Summary Sheet Criminogenic Needs')
    sanCrimTable = new CommonTables.SummarySheetCrimTable(this.page, 'R3727391167347737', 'Summary Sheet SAN Criminogenic Needs')
    ...
    predictorsTable = new CommonTables.PredictorsTable(this.page, 'R152474483953316113', 'Summary Sheet Predictor Scores')
    weighedScoresTable = new CommonTables.WeightedScoresTable(this.page, 'R4262411784053323', 'Summary Sheet Weighted Scores')
    likelihoodHarmOthersTable = new SummarySheetLikelihoodHarmOthersTable(this.page, 'R4310220450481626', 'Summary Sheet Likelihood of Serious Harm to Others')
    concernsTable = new SummarySheetConcernsTable(this.page, 'R3161211058051917', 'Summary Sheet Concerns')
...
export class SummarySheetLikelihoodHarmOthersTable extends Element.Table {
    ...
    risk = new Element.Column(this.page, Element.ColumnType.Column, `#PARENT_SECTION_QUESTION_${this.id}`, this.id)
    community = new Element.Column(this.page, Element.ColumnType.Column, `#RISK_IN_COMMUNITY_${this.id}`, this.id)
    custody = new Element.Column(this.page, Element.ColumnType.Column, `#RISK_IN_CUSTODY_${this.id}`, this.id)
}
