...
export class Section7 extends BaseAssessmentPage {
    ...
    o7_1 = new Element.Select<ProblemsAnswer>(this.page, '#itm_7_1')
    o7_2 = new Element.Select<ProblemsMissingAnswer>(this.page, '#itm_7_2')
    o7_3 = new Element.Select<ProblemsMissingAnswer>(this.page, '#itm_7_3')
    o7_4 = new Element.Select<ProblemsMissingAnswer>(this.page, '#itm_7_4')
    o7_5 = new Element.Select<ProblemsMissingAnswer>(this.page, '#itm_7_5')
    identifyIssues = new Element.Textbox(this.page, '#textarea_7_97')
    linkedToRisk = new Element.Select<YesNoAnswer>(this.page, '#itm_7_98')
    linkedToBehaviour = new Element.Select<YesNoAnswer>(this.page, '#itm_7_99')
