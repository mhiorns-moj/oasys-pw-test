...
export class CmsStubEvent extends OasysPage {
    ...
    sentenceDate = new Element.Textbox<OasysDate>(this.page, '#P200_SENTENCE_DATE', true)
    ...
    releaseDate = new Element.Textbox<OasysDate>(this.page, '#P200_RELEASE_DATE', true)
