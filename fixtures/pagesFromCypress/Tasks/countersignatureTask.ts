...
export class CountersignatureTask extends OasysPage {
    ...
    assessorCountersigner = new Element.Textbox(this.page, '#P1_RES_ASSESSOR_NAME')
    assessorCountersignerComments = new Element.Textbox(this.page, '#P1_RES_ASSESSOR_COMMENTS')
